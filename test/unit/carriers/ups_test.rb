...
class UPSTest < Test::Unit::TestCase
  ...
  def test_tracking_info
    shipment_info = @carrier.find_tracking_info("1Z0X505E4240191613",{:test => true,:key => "6CA5B8C065E6B6B0",:login => 'adamcakestyle', :password => "c@kestyle213", :origin_account => "0X505E"})
